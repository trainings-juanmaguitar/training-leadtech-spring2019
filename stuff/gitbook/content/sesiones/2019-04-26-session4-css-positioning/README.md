# Sesion 4 - CSS Positioning (23-04-2019) 

{% video %}https://vimeo.com/333311221{% endvideo %}
...
- [CSS3 CheatSheet](https://media-mediatemple.netdna-ssl.com/wp-content/uploads/images/css3-cheat-sheet/css3-cheat-sheet.pdf)  
- [CSS selectors & units](http://learn-the-web.algonquindesign.ca/topics/css-selectors-units-cheat-sheet/)  
- [Positioning CheatSheet](http://thewc.co/storage/goodies/codagogy_css_positioning_cheat_sheet.pdf)  
- [Flexbox CheatSheet](http://jonibologna.com/content/images/flexboxsheet.pdf)  
- [CSS Layout](http://learn-the-web.algonquindesign.ca/topics/css-layout-cheat-sheet/)  
